        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {logos.map((logo, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex items-center justify-center p-4 bg-gray-100 border border-gray-800/50 hover:border-[#ffff00]/50 hover:bg-gray-200 transition-all group rounded ${debug ? 'relative' : ''
                  }`}
              >
                {debug && (
